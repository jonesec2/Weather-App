...
function getCity() {
    $('#cityInput').on("click", function () {
        ...
        newCity.html(/*html*/`
            <div class="newCity">
                <button data-name='${cityName}' class="cityFont py-2 pl-4 border rounded">${cityName}</button>
            </div>
            `)
        ...
        function firstAjax() {
            $.ajax({
                ...
                <div class="box">
                    <div class="row">
                        <h2 class="col-4 mb-0 pr-0  weatherCity"> ${dataName} <img src="http://openweathermap.org/img/wn/${weatherImage}@2x.png" height="80px" width="80px"></h2>
